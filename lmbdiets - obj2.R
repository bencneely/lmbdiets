...
################################################################################
## Time to build some sweet models!
################################################################################
## Build fish model
...
## Find the highest CI estimate to set plot bounds
max(fishmod_pdat$probs_uci)

## Finally, create the plot
fish_plot=ggplot(fishmod_pdat)+
  geom_ribbon(aes(x=gzs_cpe,ymin=probs_lci,ymax=probs_uci,fill=size_class),alpha=0.2)+
...
## Find the highest CI estimate to set plot bounds
max(centrarchidmod_pdat$probs_uci)
...
## Find the highest CI estimate to set plot bounds
max(crayfishmod_pdat$probs_uci)
...
## Find the highest CI estimate to set plot bounds
max(aquaticinsectmod_pdat$probs_uci)
...
## Find the highest CI estimate to set plot bounds
max(zooplanktonmod_pdat$probs_uci)
...
check_overdispersion(fishmod)
check_overdispersion(gzsmod)
check_overdispersion(centrarchidmod)
check_overdispersion(crayfishmod)
check_overdispersion(aquaticinsectmod)
check_overdispersion(zooplanktonmod)
